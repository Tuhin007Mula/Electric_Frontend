...
const PgForm = () => {
  ...
  try {
    ...
    const payload = {
      ...
      PlantsConsumption: {
        Prep: {
          WBSEDCL: Number(formData["prep_WBSEDCL Unit"]) || 0,
          SOLAR: Number(formData["prep_SOLAR Unit"]) || 0,
          BOILER_STEAM: Number(formData["prep_BOILER Steam (Ton)"]) || 0,
          BOILER_UNIT: Number(formData["prep_BOILER Steam Unit"]) || 0,
        },
        Solvent: {
          WBSEDCL: Number(formData["solvent_WBSEDCL Unit"]) || 0,
          SOLAR: Number(formData["solvent_SOLAR Unit"]) || 0,
          BOILER_STEAM: Number(formData["solvent_BOILER Steam (Ton)"]) || 0,
          BOILER_UNIT: Number(formData["solvent_BOILER Steam Unit"]) || 0,
        },
        Refinery: {
          WBSEDCL: Number(formData["refinery_WBSEDCL Unit"]) || 0,
          SOLAR: Number(formData["refinery_SOLAR Unit"]) || 0,
          COMPRESSOR: Number(formData["refinery_COMPRESSOR Unit"]) || 0,
          BOILER_STEAM: Number(formData["refinery_BOILER Steam (Ton)"]) || 0,
          BOILER_UNIT: Number(formData["refinery_BOILER Steam Unit"]) || 0,
        },
        NewPlant: {
          WBSEDCL: Number(formData["newplant_WBSEDCL Unit"]) || 0,
          COMPRESSOR: Number(formData["newplant_COMPRESSOR Unit"])
        },
        OldPlant: {
          WBSEDCL: Number(formData["oldplant_WBSEDCL Unit"]) || 0,
          COMPRESSOR: Number(formData["oldplant_COMPRESSOR Unit"]) || 0,
        },
        Dryer: {
          WBSEDCL: Number(formData["dryer_WBSEDCL Unit"]) || 0,
          BOILER_STEAM: Number(formData["dryer_BOILER Steam (Ton)"]) || 0,
          BOILER_UNIT: Number(formData["dryer_BOILER Steam Unit"]) || 0,
        },
        Pulverizer: {
          WBSEDCL_MEGA: Number(formData["Mega Pulverizer WBSEDCL Unit"]) || 0,
          WBSEDCL_OILS: Number(formData["Oils Pulverizer WBSEDCL Unit"]) || 0,
        },
      },

      BoilerConsumption: {
        TF_Boiler: {
          WBSEDCL: Number(formData["boiler_TF_WBSEDCL Unit"]) || 0,
          RH: Number(formData["boiler_TF_Running Hour"]) || 0,
          COMPRESSOR: Number(formData["boiler_TF_COMPRESSOR Unit"]) || 0,
          HUSK: Number(formData["boiler_TF_Husk Consumption (Ton)"]) || 0,
        },
        TON_12_Boiler: {
          WBSEDCL: Number(formData["boiler_12_WBSEDCL Unit"]) || 0,
          SOLAR: Number(formData["boiler_12_SOLAR Unit"]) || 0,
          RH: Number(formData["boiler_12_Running Hour"]) || 0,
          RO: Number(formData["boiler_12_RO Unit"]) || 0,
          COMPRESSOR: Number(formData["boiler_12_COMPRESSOR Unit"]) || 0,
          STEAM: Number(formData["boiler_12_Steam Generation (Ton)"]) || 0,
          WATER: Number(formData["boiler_12_Water Consumption (Ton)"]) || 0,
          HUSK: Number(formData["boiler_12_Husk Consumption (Ton)"]) || 0,
        },
        TON_18_Boiler: {
          WBSEDCL: Number(formData["boiler_18_WBSEDCL Unit"]) || 0,
          RH: Number(formData["boiler_18_Running Hour"]) || 0,
          RO: Number(formData["boiler_18_RO Unit"]) || 0,
          COMPRESSOR: Number(formData["boiler_18_COMPRESSOR Unit"]) || 0,
          STEAM: Number(formData["boiler_18_Steam Generation (Ton)"]) || 0,
          WATER: Number(formData["boiler_18_Water Consumption (Ton)"]) || 0,
          HUSK: Number(formData["boiler_18_Husk Consumption (Ton)"]) || 0,
        },
      },

      CompressorConsumption: {
        //ELGI: Number(formData.comp_ELGI) || 0,
        ELGI_WBSEDCL: Number(formData["comp_ELGI WBSEDCL Unit"]) || 0,
        KAESER_1_WBSEDCL: Number(formData["comp_Kaeser 1 WBSEDCL Unit"]) || 0,
        KAESER_2_WBSEDCL: Number(formData["comp_Kaeser 2 WBSEDCL Unit"]) || 0,
        ELGI_SOLAR: Number(formData["comp_ELGI SOLAR Unit"]) || 0,
        KAESER_1_SOLAR: Number(formData["comp_Kaeser 1 SOLAR Unit"]) || 0,
        KAESER_2_SOLAR: Number(formData["comp_Kaeser 2 SOLAR Unit"]) || 0,
        ELGI_RH: Number(formData["ELGI Running Hour"]) || 0,
        KAESER_1_RH: Number(formData["Kaeser 1 Running Hour"]) || 0,
        KAESER_2_RH: Number(formData["Kaeser 2 Running Hour"]) || 0,
      },
